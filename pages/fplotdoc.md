...
**fplot**{: style="color: blue"} generates a file _fplot.ps_{: style="color: green"}.
...
Section 3 explains the sizeable number of command-line arguments **fplot**{: style="color: blue"} will accept.
This sections develops a couple of examples to give you an intuitive feel of how the code operates and many of the settings you typically want to control yourself.
