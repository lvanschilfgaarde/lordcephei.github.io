...
You will need some capability to display postscript files.   **fplot**{: style="color: blue"} generates a file **fplot.ps**{: style="color: green"}

_____________________________________________________________

### 3. _Introduction_

**fplot**{: style="color: blue"} is mainly intended for _xy_ figures; it has some capability for countour plots and a very limited ability
for 3D graphics.
