...
If you want to practice finding $$E_F$$ using **lm**{: style="color: blue"} use the following commands (for the details see [ASA-tutorial](https://lordcephei.github.io/asa-doc/)):
