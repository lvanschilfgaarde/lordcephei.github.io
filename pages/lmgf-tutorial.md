...
You can now proceed to self-consistency but we will instead use the potential generated by lm in order to make the exchange parameters. 

[^1]: Some *crazy* footnote definition.

At the prompt enterr
