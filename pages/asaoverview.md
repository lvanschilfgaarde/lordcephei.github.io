...
#### _Determining initial values of sphere radii_
{::comment}
/docs/asaoverview/#choosing-initial-values-of-sphere-radii/
{:/comment}

The ideal choice of sphere radii best approximates a potential that is spherical within the MT spheres and flat outside.  
...
near neighbors.  The MT radius is taken as the first potential maximum along any ray.  This choice is a pretty reasonable estimate for the
...
+ **lmchk**{: style="color: blue"} will use it the algorithm and print the results to stdout if you invoke it with

~~~
lmchk --getwsr ...
~~~
you must use your editor to copy the output to **SPEC_ATOM_RMAX** tags in the ctrl file.
There is at present no automatic way to use the radii generated by lmchk.

#### _Automatic scaling of sphere radii_
{::comment}
/docs/asaoverview/#automatic-scaling-of-sphere-radii/
{:/comment}
