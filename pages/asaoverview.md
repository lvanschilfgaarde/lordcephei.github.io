...
('potential parameers') inside each augmentation sphere.  These
...
### _Logarithmic Derivatives_

For a fixed spherical potential, the "partial wave" (i.e. radial Schrodinger equation)
and its energy are uniquely determined by the boundary condition at the augmentation radius _s_.
This is normally given through the "logarithmic derivative function"

$$ D_l(\varepsilon) \equiv D\{\phi_l(\varepsilon)\} = \left( {\frac{r}{\phi_l(\varepsilon,r)}}
