...
![QSGW+DMFT full loop](https://github.com/lordcephei/lordcephei.github.io/assets/img/qsgwdmft-loop.png)
...
1. [The first tutorial](https://github.com/lordcephei/lordcephei.github.io/dmft1) is about how to perform a DMFT loop until convergence.
2. [The second one](https://github.com/lordcephei/lordcephei.github.io/dmft2) is about possible errors and some indications and rules-of-thumb to adjust parameters in performing a DMFT loop.
3. [The third tutorial](https://github.com/lordcephei/lordcephei.github.io/dmft3) is about how to close the density loop by means of the static spin-averaged+spin-flip approach.
4. [The forth tutorial](https://github.com/lordcephei/lordcephei.github.io/dmft4) is about how to close the density loop by updating the density with the dynamical approach (standard method).
