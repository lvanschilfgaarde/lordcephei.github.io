...
Lattice vectors are given in Cartesian coordinates in units of **A**.
...
**UNITS=A** tells **blm**{: style="color: blue"} that **A** is in &#x212B;.  If you do not specify, 
**A** is given in atomic units (This code uses Atomic Rydberg units).  

Lattice constant and the position of the basis vectors place in **SITE** is all that is needed to fix the structural information.  Atomic
